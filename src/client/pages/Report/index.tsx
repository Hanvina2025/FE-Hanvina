...
export default function ReportChart() {
  ...
  return (
    <div className="max-w-7xl mx-auto  bg-white p-5 rounded-[20px] shadow-md mb-[100px]">
      <h2 className="text-xl font-medium mb-5 text-[#141415] py-2">Báo cáo</h2>
              ...
              <div className="mt-2 z-20">
                ...
                <p
                  className={`text-xl font-medium my-2 ${
                    selectedIndex === idx ? "text-[#723711]" : "text-[#BB2C26]"
                  }`}
                >
                ...
                <span
                  className={`font-sm   ${
                    selectedIndex === idx ? "text-[#A35505]" : "text-[#8F9499]"
                  }`}
                >
                  {item.unit}
                </span>
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-semibold">Tổng doanh thu</h3>
        <div className="relative">
          <div
            className="flex cursor-pointer items-center justify-between gap-2 text-sm text-gray-600 border border-[#E9EBED] rounded-[100px] min-w-[276px] px-4 py-3"
            onClick={() => setShowDatePicker(!showDatePicker)}
          >
            <div>
              <span>Thời gian: </span>
              <span>{selectedDate ? selectedDate : "Tất cả"}</span>
            </div>
          ...
          {showDatePicker && (
            <div className="absolute top-full right-0 bg-white shadow-md z-50">
              <DateRangePicker
                onConfirm={(date) => {
                  console.log("🚀 ~ ReportChart ~ date:", date);
