            ...
            <div className='grid lg:grid-cols-[125px_1fr] gap-[60px]'>
              ...
              <div className='profile-right-info-content'>
                <div className='item'>
                  ...
                  <input className="border border-[#D6D9DC] rounded-lg w-full p-3 mt-2" type="text" placeholder='Tên đại lý'/>
                </div>
                <div className='item mt-[24px]'>
                  <div className='font-[500]'>Số điện thoại</div>
                  <input className="border border-[#D6D9DC] rounded-lg w-full p-3 mt-2" type="number" placeholder='Số điện thoại'/>
                </div>
                <div className='item mt-[24px]'>
                  <div className='font-[500]'>Email</div>
                  <input className="border border-[#D6D9DC] rounded-lg w-full p-3 mt-2" type="email" placeholder='Email'/>
                </div>
