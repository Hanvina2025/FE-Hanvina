...
import paymentDone from "/assets/images/paymentDone.svg";
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-12 gap-x-8 ">
        <div className="md:col-span-7">
          <div className="mt-9 flex items-center gap-x-7">
            ...
            <div className="text-[#34B764] text-[24px] font-[500] flex items-center gap-2">
              <img src={paymentDoneCheck} /> XÁC NHẬN BOOKING!
            </div>
          </div>
